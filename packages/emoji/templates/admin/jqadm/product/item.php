                ...
                <div class="box"
                    ...
                    <div class="row">
                        <div class="col-xl-6 block" v-bind:class="{readonly: !can('change')}">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 form-control-label help"><?= $enc->html( $this->translate( 'admin', 'Emojis count' ) ) ?></label>
                                <div class="col-sm-8">
                                <span><?= $this->itemEmojisCount ?> <a href="/emoji/purge/<?= $this->get( 'itemData/product.id' ) ?>">Purge Emojis</a></span>
                                </div>
                                <div class="col-sm-12 form-text text-muted help-text">
                                    <?= $enc->html( $this->translate( 'admin', 'The number of all emojis for current product' ) ) ?>
                                </div>
                            </div>
