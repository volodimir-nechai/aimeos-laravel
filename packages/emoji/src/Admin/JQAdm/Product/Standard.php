    ...
    implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
    ...
    public function data( \Aimeos\Base\View\Iface $view ) : \Aimeos\Base\View\Iface
    {
        ...
        $view->itemEmojisCount = $this->getProductEmojisCount( $view->param( 'id' ) );
        return $view;
    }
    ...
    /**
     * Count all emojis for current product
     *
     * @return int
     */
    protected function getProductEmojisCount( string $id ) : int
    {
        return MshopEmojiUserProductRelation::where( 'product_id', $id )->count();
    }
}
